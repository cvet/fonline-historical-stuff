...
#define FT_BOTTOM		8
//!Cvet +++
#define FT_UPPER		16 //текст выводитьс€ начина€ с нижней границы
#define FT_COLORIZE		32 //раскрасска. без флага цвет беретьс€ из передоваемого аргумента col
//!Cvet ---
...
private:
	...
	int spr_cnt;//на сколько спрайтов рассчитан. при достижении рисуетс€ сам.

	LPDIRECT3DDEVICE8 lpDevice;

	LPDIRECT3DVERTEXBUFFER8 lpVB;//буфер с вершинами дл€ спрайтов
	LPDIRECT3DINDEXBUFFER8 lpIB;//буфер с индексами

	//Ѕуфер вершин в системной пам€ти дл€ посто€нно мен€ющихс€ спрайтов
	MYVERTEX* lpWaitBuf;
