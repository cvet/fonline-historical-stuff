...
//!Cvet ++++++++++++++++++++++++++++++++++  Инвентарь
	...
	int Move(BYTE dir, WORD after_move_pause); // Анимация движения
...
//	BYTE rx,ry; // x,y координаты экрана в гексах
...
private:
    ...
    CritFrames* cur_anim; // текущий тип анимации
